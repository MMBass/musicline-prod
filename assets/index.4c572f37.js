...
`;function bt({className:t}){const r=u.exports.useContext(j),o=u.exports.useContext(H),n=u.exports.useContext(M);u.exports.useRef(null);const s=Ie({key:"muirtl",stylisPlugins:[_e,je]});function l(){h()}const h=()=>{const d=document.createElement("script");d.type="text/javascript",d.src="https://cse.google.com/cse.js?cx=a85c2374ffc8b8898",d.defer=!0,document.body.appendChild(d)};u.exports.useEffect(()=>{l()},[n]);const a=d=>{n.closeBanner(d)};return ee({palette:{mode:"dark"}}),f("div",{className:t,children:[e(Me,{value:s,children:f(Pe,{children:[e(We,{}),e(ot,{className:"header"}),n.main.open&&f(J,{severity:"warning",className:"main-alert",children:[e(oe,{children:n.main.title}),n.main.message]}),e(it,{children:f(Re,{children:[e(Z,{path:"/",element:e(yt,{className:"page"})}),e(Z,{path:"*",element:e(St,{className:"page"})})]})}),r.open&&r.child&&e(ct,{className:"drawer"}),o.main.open&&e(se,{color:o.main.color||"primary"}),o.circular.open&&e(Oe,{color:o.main.color||"primary"}),n.snackbar.open&&e($e,{open:n.snackbar.open,autoHideDuration:6e3,onClose:()=>{},children:e(J,{onClose:()=>{a("snackbar")},severity:n.snackbar.severity,sx:{width:"100%"},children:n.snackbar.message})}),e(ut,{})]})}),e(mt,{})]})}const vt=S(bt)`
  height: 100vh;
  height: fit-content;
  min-height: 700px;
  color: ${t=>t.theme.palette.secondary.main};
