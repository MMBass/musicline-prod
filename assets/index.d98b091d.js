...
`;const at=o=>{var s=o,{className:t}=s,n=A(s,["className"]);var r,h,x,S;u.exports.useContext(J);const i=u.exports.useContext(z),l=u.exports.useContext(M),[m,a]=u.exports.useState(!1),D=function(){sessionStorage.removeItem("currLines")};return u.exports.useEffect(()=>{var T;a(((T=l.error)==null?void 0:T.open)&&!0)},[(r=l.error)==null?void 0:r.open]),f(be,{position:"sticky",className:t,children:[e(ve,{maxWidth:"xl",children:f(we,{disableGutters:!0,children:[e(q,{to:"/",onClick:()=>{D()},children:e(k,{variant:"h6",noWrap:!0,component:"h1",sx:{mr:2,display:"flex"},children:"\u05DE\u05D9\u05D5\u05D6\u05D9\u05E7 \u05DC\u05D9\u05D9\u05DF"})}),i.lines[0]&&e(tt,{})]})}),e(Le,{in:(h=l.error)==null?void 0:h.open,children:f(U,{severity:"error",className:"error-alert",onClose:()=>{l.closeBanner("error")},children:[e(ae,{children:(x=l.error)==null?void 0:x.title}),(S=l.error)==null?void 0:S.message]})})]})},ut=v(at)`
